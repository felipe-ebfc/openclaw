...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    overview: "Status, connections, and a quick health check.",
    ...
    chat: "Chat with your AI companion.",
    config: "Edit ~/.openclaw/openclaw.json safely.",
    debug: "Snapshots, events, and diagnostics.",
    logs: "Live log output.",
  },
  overview: {
    access: {
      title: "Connection",
      subtitle: "How the app connects and authenticates.",
      wsUrl: "WebSocket URL",
      token: "Access Token",
    ...
    stats: {
      ...
      sessions: "Sessions",
      sessionsHint: "Recent conversation sessions.",
      cron: "Cron",
    ...
    notes: {
      ...
      tailscaleText: "Prefer serve mode to keep connections on loopback with tailnet auth.",
    ...
    auth: {
      required: "Authentication required. Add a token or password, then click Connect.",
      failed:
        "Auth failed. Re-copy a tokenized URL with {command}, or update the token, then click Connect.",
    },
    pairing: {
      hint: "This device needs pairing approval from the host.",
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from openclaw dashboard --no-open on your desktop.",
    },
    insecure: {
      hint: "This page is HTTP, so the browser blocks device identity. Use HTTPS (Tailscale Serve) or open {url} on the host.",
      stayHttp: "If you must stay on HTTP, set {config} (token-only).",
    },
  },
  chat: {
    disconnected: "Getting your companion ready...",
  ...
  cron: {
    ...
    form: {
      ...
      systemEventHelp: "Sends your text to the main timeline (good for reminders/triggers).",
      ...
      clearAgentHelp: "Force this job to use the default assistant.",
