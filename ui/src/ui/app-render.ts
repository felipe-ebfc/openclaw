...
import { renderBrainTipCard } from "./views/brain-tip-card.ts";
...
import { renderWelcomeOverlay } from "./views/welcome-overlay.ts";
        ...
        ${
          state.tab === "chat"
            ? renderChat({
                ...
                onNewSession: () => state.handleSendChat("/fresh", { restoreDraft: true }),
                ...
                tipCard: state.brainTipVisible ? renderBrainTipCard(state) : nothing,
              })
            : nothing
        }
